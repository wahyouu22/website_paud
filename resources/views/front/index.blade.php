...
<body class="text-black font-poppins pt-10 pb-[50px]">
    <div id="hero-section"
        ...
        <nav class="flex justify-between items-center pt-6 px-[50px]">
            <a href="{{ route('front.index') }}">
                ...
                <h1 class="font-bold text-white " style="font-size: 30px">PAUD Harum</h1>
            </a>
        ...
        <div class="flex flex-col items-center gap-[30px]">
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <p class="text-center text-xl leading-[36px] text-[#F5F8FA]">PAUD Harum menyediakan kursus online
    ...
    <footer
        ...
        <div class="flex justify-between">
            <a href="">
                <div>
                    <h1 class="font-bold text-black " style="font-size: 30px">PAUD Harum</h1>
                </div>
            </a>
